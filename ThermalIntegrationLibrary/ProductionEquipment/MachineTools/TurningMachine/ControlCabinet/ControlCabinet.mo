within ThermalIntegrationLibrary.ProductionEquipment.MachineTools.TurningMachine.ControlCabinet;
model ControlCabinet
  parameter Modelica.Units.SI.Mass m_controlCabinet "Mass of control cabinet";
  parameter Modelica.Units.SI.SpecificHeatCapacity cp_controlCabinet "Specific heat capacity of control cabinet";
