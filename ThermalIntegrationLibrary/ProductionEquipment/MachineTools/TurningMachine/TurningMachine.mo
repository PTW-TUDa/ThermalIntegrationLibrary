...
model TurningMachine
  ...
  replaceable parameter ThermalIntegrationLibrary.ProductionEquipment.MachineTools.TurningMachine.TechnicalConfiguration.TechnicalConfiguration_a TechnicalConfiguration constrainedby ThermalIntegrationLibrary.ProductionEquipment.MachineTools.TurningMachine.TechnicalConfiguration.BaseClasses.TechnicalConfiguration_base annotation (choicesAllMatching=true);

  replaceable parameter ThermalIntegrationLibrary.ProductionEquipment.MachineTools.TurningMachine.ProcessingProgramms.Kugelspiel_OP10 ProcessingProgramm_1 constrainedby ThermalIntegrationLibrary.ProductionEquipment.MachineTools.TurningMachine.ProcessingProgramms.BaseClasses.ProcessingProgramm_base "Table which defines power demand of components during operating modes (operating mode = first column; power demand = following columns)"
    annotation (choicesAllMatching=true, Placement(transformation(extent={{-190,-190},{-170,-170}})));
  replaceable parameter ThermalIntegrationLibrary.ProductionEquipment.MachineTools.TurningMachine.ProcessingProgramms.Kugelspiel_OP20 ProcessingProgramm_2 constrainedby ThermalIntegrationLibrary.ProductionEquipment.MachineTools.TurningMachine.ProcessingProgramms.BaseClasses.ProcessingProgramm_base "Table which defines power demand of components during operating modes (operating mode = first column; power demand = following columns)"
    annotation (choicesAllMatching=true, Placement(transformation(extent={{-150,-190},{-130,-170}})));
  replaceable parameter ThermalIntegrationLibrary.ProductionEquipment.MachineTools.TurningMachine.ProcessingProgramms.Steuerscheibe_OP10 ProcessingProgramm_3 constrainedby ThermalIntegrationLibrary.ProductionEquipment.MachineTools.TurningMachine.ProcessingProgramms.BaseClasses.ProcessingProgramm_base "Table which defines power demand of components during operating modes (operating mode = first column; power demand = following columns)"
    annotation (choicesAllMatching=true, Placement(transformation(extent={{-110,-190},{-90,-170}})));
  replaceable parameter ThermalIntegrationLibrary.ProductionEquipment.MachineTools.TurningMachine.ProcessingProgramms.Steuerscheibe_OP20 ProcessingProgramm_4 constrainedby ThermalIntegrationLibrary.ProductionEquipment.MachineTools.TurningMachine.ProcessingProgramms.BaseClasses.ProcessingProgramm_base "Table which defines power demand of components during operating modes (operating mode = first column; power demand = following columns)"
    annotation (choicesAllMatching=true, Placement(transformation(extent={{-70,-190},{-50,-170}})));
  ThermalIntegrationLibrary.ProductionEquipment.MachineTools.TurningMachine.ThermalSystem.ThermalSystem thermalSystem(
  ...
  ThermalIntegrationLibrary.ProductionEquipment.MachineTools.TurningMachine.Drives.Drives drives annotation (Placement(transformation(extent={{-40,-90},{-20,-70}})));
  Modelica.Blocks.Math.MultiSum DC(nu=1) annotation (Placement(transformation(extent={{-6,-86},{6,-74}})));
  ThermalIntegrationLibrary.ProductionEquipment.MachineTools.TurningMachine.ProcessController.ProcessController processController(
  ...
  ThermalIntegrationLibrary.ProductionEquipment.MachineTools.TurningMachine.CoolingLubricantSystem.CoolingLubricantSystem coolingLubricantSystem annotation (Placement(transformation(extent={{-40,-10},{-20,10}})));
  ThermalIntegrationLibrary.ProductionEquipment.MachineTools.TurningMachine.HydraulicSystem.HydraulicSystem hydraulicSystem annotation (Placement(transformation(extent={{-40,-50},{-20,-30}})));
  ...
  ThermalIntegrationLibrary.ProductionEquipment.MachineTools.TurningMachine.ControlCabinet.ControlCabinet controlCabinet(
    m_controlCabinet=20,
  ...
  ThermalIntegrationLibrary.ProductionEquipment.MachineTools.TurningMachine.CoolingSystem.CentralCoolWater centralCoolWater(T_flow=TechnicalConfiguration.T_target_coolWater - 5) annotation (Placement(transformation(extent={{120,110},{140,130}})));
  ThermalIntegrationLibrary.ProductionEquipment.MachineTools.TurningMachine.CoolingSystem.ColdWaterNetwork coldWater(heatCapacitor(T(start=TechnicalConfiguration.T_target_coldWater))) annotation (Placement(transformation(extent={{20,90},{40,110}})));
  ThermalIntegrationLibrary.ProductionEquipment.MachineTools.TurningMachine.CoolingSystem.CentralColdWater centralColdWater(T_flow=TechnicalConfiguration.T_target_coldWater - 5) annotation (Placement(transformation(extent={{120,90},{140,110}})));
  ThermalIntegrationLibrary.ProductionEquipment.MachineTools.TurningMachine.TransferUnit.TransferUnit transferUnit2(
  ...
  ThermalIntegrationLibrary.ProductionEquipment.MachineTools.TurningMachine.TransferUnit.TransferUnit transferUnit3(
  ...
  ThermalIntegrationLibrary.ProductionEquipment.MachineTools.TurningMachine.CoolingSystem.ColdWaterNetwork coolWater(heatCapacitor(T(start=TechnicalConfiguration.T_target_coolWater))) annotation (Placement(transformation(extent={{40,110},{20,130}})));
  ...
  ThermalIntegrationLibrary.ProductionEquipment.MachineTools.TurningMachine.CoolingSystem.CompressionChillers.CompressionChiller compressionChiller(
  ...
  ThermalIntegrationLibrary.ProductionEquipment.MachineTools.TurningMachine.CoolingSystem.CompressionChillers.CompressionChiller_onePort compressionChiller_onePort(
