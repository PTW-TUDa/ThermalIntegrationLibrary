...
model CabinetCleaningMachine
  ...
  replaceable parameter ThermalIntegrationLibrary.Examples.Records.ETA_TechnicalConfiguration_CabinetCleaningMachine TechnicalConfiguration constrainedby ThermalIntegrationLibrary.ProductionEquipment.CleaningMachines.CabinetCleaningMachine.TechnicalConfiguration.BaseClasses.TechnicalConfiguration_base annotation (choicesAllMatching=true);
