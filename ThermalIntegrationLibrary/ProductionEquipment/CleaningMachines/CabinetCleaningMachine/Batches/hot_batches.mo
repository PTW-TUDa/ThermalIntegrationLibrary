within ThermalIntegrationLibrary.ProductionEquipment.CleaningMachines.CabinetCleaningMachine.Batches;
model hot_batches
...
equation
  ...
  connect(single_hot_batch2.port_hall, thermalCollector.port_a[2])
    annotation (Line(points={{10,36},{40,36},{40,0},{50.2,5.55112e-16}},           color={191,0,0}));
  ...
  connect(thermalCollector.port_a[4], single_hot_batch4.port_hall)
    annotation (Line(points={{49.8,4.44089e-16},{40,0},{40,-36},{10,-36}},           color={191,0,0}));
  connect(thermalCollector.port_a[5], single_hot_batch5.port_hall)
    annotation (Line(points={{49.6,4.44089e-16},{40,0},{40,-70},{10,-70}},           color={191,0,0}));
