...
model single_hot_batch
  ...
  ThermalIntegrationLibrary.ProductionEquipment.CleaningMachines.CabinetCleaningMachine.TankHeating.thermOnOff thermOnOff annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=270,
        origin={0,0})));
