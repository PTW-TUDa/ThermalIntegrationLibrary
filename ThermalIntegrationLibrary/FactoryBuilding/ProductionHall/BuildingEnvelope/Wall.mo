...
model Wall
  ...
  replaceable parameter ThermalIntegrationLibrary.FactoryBuilding.ProductionHall.BuildingEnvelope.Records.WallProperties deviceData constrainedby ThermalIntegrationLibrary.FactoryBuilding.ProductionHall.BuildingEnvelope.Records.WallProperties annotation (__Dymola_choicesAllMatching=true);
