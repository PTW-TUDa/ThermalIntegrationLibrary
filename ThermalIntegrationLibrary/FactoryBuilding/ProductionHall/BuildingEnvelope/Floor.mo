...
model Floor
  ...
  replaceable parameter ThermalIntegrationLibrary.FactoryBuilding.ProductionHall.BuildingEnvelope.Records.FloorProperties deviceData constrainedby ThermalIntegrationLibrary.FactoryBuilding.ProductionHall.BuildingEnvelope.Records.FloorProperties annotation (__Dymola_choicesAllMatching=true);
