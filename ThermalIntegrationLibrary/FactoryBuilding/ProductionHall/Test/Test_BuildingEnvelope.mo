within ThermalIntegrationLibrary.FactoryBuilding.ProductionHall.Test;
model Test_BuildingEnvelope
    extends ThermalIntegrationLibrary.BaseClasses.BaseFactoryBuilding(
  ...
  ThermalIntegrationLibrary.FactoryBuilding.ProductionHall.BuildingEnvelope.FactoryBuilding FactoryBuilding annotation (Placement(transformation(extent={{0,0},{20,20}})));
