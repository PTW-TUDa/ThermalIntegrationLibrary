...
model Test_MachineBuildingInteraction
  ...
  ProductionEquipment.CleaningMachines.CabinetCleaningMachine.CabinetCleaningMachine cabinetCleaningMachine(ID=2, redeclare ThermalIntegrationLib.Examples.Records.ETA_TechnicalConfiguration_CabinetCleaningMachine TechnicalConfiguration) annotation (Placement(transformation(extent={{-56,-6},{-24,26}})));
  ProductionEquipment.Ovens.AnnealingOven.AnnealingOven annealingOven(ID=4, redeclare ThermalIntegrationLib.Examples.Records.ETA_TechnicalConfiguration_AnnealingOven TechnicalConfiguration) annotation (Placement(transformation(extent={{10,-20},{70,40}})));
