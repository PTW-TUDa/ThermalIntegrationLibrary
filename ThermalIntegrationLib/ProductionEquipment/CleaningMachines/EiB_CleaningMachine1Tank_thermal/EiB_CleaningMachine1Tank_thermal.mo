...
model EiB_CleaningMachine1Tank_thermal
...
// Heat demand represents heat influx from central heating system
  ...
  connect(hot_batches.port_hall, thermalCollector.port_a[2])
    annotation (Line(points={{10,-130},{80,-130},{80,-80},{80.5,-80}}, color={191,0,0}));
  ...
  connect(thermTankHeating1.port_hall, thermalCollector.port_a[1])
    annotation (Line(points={{10,-30},{80,-30},{80,-80},{79.5,-80}}, color={191,0,0}));
  ...
  connect(elBaseLoad.y, P_el.u[1]) annotation (Line(points={{11,130},{50,130},{50,102.1},{56,102.1}}, color={0,0,127}));
  connect(P_el.u[2], mech_processes1.P_el) annotation (Line(points={{56,97.9},{50,97.9},{50,70},{11,70}}, color={0,0,127}));
