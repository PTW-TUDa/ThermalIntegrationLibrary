...
package Batches
  ...
  equation
    connect(new_batch, batch_controller1.new_batch) annotation (Line(points={{-110,-40},{-81,-40}},
                                                                                                color={255,0,255}));
    ...
    connect(T_hall, single_hot_batch1.T_hall)
      annotation (Line(points={{-110,40},{-48,40},{-48,84},{-12,84}}, color={0,0,127}));
    ...
    connect(single_hot_batch5.T_hall, T_hall) annotation (Line(points={{-12,-76},{-42,-76},{-42,-36},{-48,-36},{-48,40},{-110,40}},
                                                                                                                color={0,0,127}));
    connect(single_hot_batch2.T_hall, single_hot_batch1.T_hall)
      annotation (Line(points={{-12,44},{-48,44},{-48,84},{-12,84}}, color={0,0,127}));
    connect(single_hot_batch3.T_hall, T_hall) annotation (Line(points={{-12,4},{-48,4},{-48,40},{-110,40}}, color={0,0,127}));
    connect(single_hot_batch4.T_hall, T_hall) annotation (Line(points={{-12,-36},{-48,-36},{-48,40},{-110,40}}, color={0,0,127}));
    ...
    connect(single_hot_batch5.Q_dot_single_hot_batch, multiSum.u[5])
      annotation (Line(points={{11,-80},{42,-80},{42,-3.36},{54,-3.36}},
                                                                 color={0,0,127}));
