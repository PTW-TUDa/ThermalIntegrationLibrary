...
package BaseClasses
  record TechnicalConfiguration_base
    ...
    parameter Modelica.Units.SI.Mass m_t2 "Mass of cleaning fluid tank 2" annotation (Dialog(tab="Tanks", group="Tank parameters"));
    parameter Modelica.Units.SI.Area A_t2 "Surface area of tank 2" annotation (Dialog(tab="Tanks", group="Tank parameters"));
    ...
    parameter Modelica.Units.SI.Length d_ins "Thickness insulation (for no insulation set to 0)" annotation (Dialog(tab="Insulation"));
