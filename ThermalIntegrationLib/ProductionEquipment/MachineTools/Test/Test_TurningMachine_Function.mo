...
algorithm
  simulateModel("ThermalIntegrationLib.ProductionEquipment.MachineTools.Testers.Tester1_EiB_MachineTool", stopTime=30000, method="Cvode", resultFile="Tester1_EiB_MachineTool") annotation(__Dymola_interactive=true);
