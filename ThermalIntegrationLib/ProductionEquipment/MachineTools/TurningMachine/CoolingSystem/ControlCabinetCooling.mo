within ThermalIntegrationLib.ProductionEquipment.MachineTools.TurningMachine.CoolingSystem;
model ControlCabinetCooling
  parameter Boolean IsUsed "True if used. False if unused";
  parameter Modelica.SIunits.ThermodynamicTemperature T_flow = 288.15;
  parameter Modelica.SIunits.Power P_el_nom_vent "Nominal electric power of the vent";
  parameter Modelica.SIunits.MassFlowRate m_flow_nom_vent "Nominal mass flow rate of the vent";
  parameter Modelica.SIunits.SpecificHeatCapacity cp_air = 1000 "Specific heat capacity of air";
  Modelica.SIunits.Power P_th_cool "Cooling power of control cabinet cooling";
  Modelica.SIunits.MassFlowRate m_flow_vent "Mass flow of the vent";
