...
model ColdWaterNetwork
  parameter Modelica.SIunits.Mass m_coldWaterNetwork = 20 "Total mass within cold water network";
  parameter Modelica.SIunits.SpecificHeatCapacity cp_coldWaterNetwork = 4185 "Specific heat capacity of cold water network";
