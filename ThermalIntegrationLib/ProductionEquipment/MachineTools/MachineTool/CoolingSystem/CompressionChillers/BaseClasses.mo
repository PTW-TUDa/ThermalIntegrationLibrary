...
package BaseClasses
  ...
  model ConditionCheck
    //## PARAMETERS ##
    parameter Modelica.SIunits.Temperature T_in_cool_min = 273.15+10 "Minimal cool instream temperature";
    parameter Modelica.SIunits.Temperature T_in_cool_max = 273.15+80 "Maximal cool instream temperature";
    parameter Modelica.SIunits.Temperature T_in_heat_min = 273.15+10 "Minimal heat instream temperature";
    parameter Modelica.SIunits.Temperature T_in_heat_max = 273.15+80 "Maximal heat instream temperature";
