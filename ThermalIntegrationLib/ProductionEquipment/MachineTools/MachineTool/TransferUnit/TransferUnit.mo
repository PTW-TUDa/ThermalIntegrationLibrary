within ThermalIntegrationLib.ProductionEquipment.MachineTools.MachineTool.TransferUnit;
model TransferUnit
  parameter Boolean IsUsed "True if used. False if unused";
  parameter Modelica.SIunits.ThermalConductance lambda;
  parameter Modelica.SIunits.ThermodynamicTemperature T_target;
