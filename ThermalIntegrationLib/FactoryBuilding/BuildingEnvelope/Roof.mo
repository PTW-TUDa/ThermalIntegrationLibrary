...
model Roof
  ...
  replaceable parameter ThermalIntegrationLib.FactoryBuilding.BuildingEnvelope.Records.RoofProperties deviceData constrainedby ThermalIntegrationLib.FactoryBuilding.BuildingEnvelope.Records.RoofProperties annotation (__Dymola_choicesAllMatching=true);
