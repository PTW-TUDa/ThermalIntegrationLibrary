within ThermalIntegrationLib.FactoryBuilding.BuildingEnvelope;
model Wall
  ...
  replaceable parameter ThermalIntegrationLib.FactoryBuilding.BuildingEnvelope.Records.WallProperties deviceData constrainedby ThermalIntegrationLib.FactoryBuilding.BuildingEnvelope.Records.WallProperties annotation (__Dymola_choicesAllMatching=true);
equation
