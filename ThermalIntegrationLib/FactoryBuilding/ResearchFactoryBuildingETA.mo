...
model ResearchFactoryBuildingETA
...
equation
  ...
  connect(wallWestETA.Inside, convectiveResistor2.solid) annotation (Line(points={{-20,100},{30,100},{30,0},{62,0}}, color={191,0,0}));
  ...
  connect(convectiveResistor3.fluid, wallWestETA.Outside) annotation (Line(points={{-60,40},{-52,40},{-52,100},{-40,100}}, color={191,0,0}));
...
end ResearchFactoryBuildingETA;
