...
model Floor
  ...
  replaceable parameter ThermalIntegrationLib.FactoryBuilding.ProductionHall.BuildingEnvelope.Records.FloorProperties deviceData constrainedby ThermalIntegrationLib.FactoryBuilding.ProductionHall.BuildingEnvelope.Records.FloorProperties annotation (__Dymola_choicesAllMatching=true);
