...
model Wall
  ...
  replaceable parameter ThermalIntegrationLib.FactoryBuilding.ProductionHall.BuildingEnvelope.Records.WallProperties deviceData constrainedby ThermalIntegrationLib.FactoryBuilding.ProductionHall.BuildingEnvelope.Records.WallProperties annotation (__Dymola_choicesAllMatching=true);
