within ThermalIntegrationLib.FactoryBuilding.ProductionHall.Test;
model Test_BuildingEnvelope
  ...
  ThermalIntegrationLib.FactoryBuilding.ProductionHall.BuildingEnvelope.FactoryBuilding FactoryBuilding annotation (Placement(transformation(extent={{0,0},{20,20}})));
