...
model Roof
  ...
  Modelica.Thermal.HeatTransfer.Components.HeatCapacitor RoofMass annotation (Placement(transformation(extent={{-10,0},{10,20}})));
equation
  ...
  connect(HalfWallResistanceInside.port_a, RoofMass.port) annotation (Line(points={{60,0},{0,0}}, color={191,0,0}));
  connect(RoofMass.port, HalfWallResistanceOutside.port_b) annotation (Line(points={{0,0},{-46,0}}, color={191,0,0}));
