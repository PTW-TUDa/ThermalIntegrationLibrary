...
model Floor
  ...
  Modelica.Thermal.HeatTransfer.Components.HeatCapacitor FloorMass annotation (Placement(transformation(extent={{-10,0},{10,20}})));
equation
  ...
  connect(HalfWallResistanceInside.port_a, FloorMass.port) annotation (Line(points={{60,0},{0,0}}, color={191,0,0}));
  connect(FloorMass.port, HalfWallResistanceOutside.port_b) annotation (Line(points={{0,0},{-46,0}}, color={191,0,0}));
