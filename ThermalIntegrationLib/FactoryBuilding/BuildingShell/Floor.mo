...
model Floor
  ...
  replaceable parameter ThermalIntegrationLib.FactoryBuilding.BuildingShell.Records.WallProperties deviceData constrainedby ThermalIntegrationLib.FactoryBuilding.BuildingShell.Records.WallProperties annotation (__Dymola_choicesAllMatching=true);
equation
