...
model Wall
  ...
  replaceable parameter ThermalIntegrationLib.FactoryBuilding.BuildingElements.Records.WallProperties deviceData constrainedby ThermalIntegrationLib.FactoryBuilding.BuildingElements.Records.WallProperties annotation (__Dymola_choicesAllMatching=true);
