...
model Floor
  ...
  replaceable parameter ThermalIntegrationLib.FactoryBuilding.BuildingElements.Records.FloorProperties deviceData constrainedby ThermalIntegrationLib.FactoryBuilding.BuildingElements.Records.FloorProperties annotation (__Dymola_choicesAllMatching=true);
