...
model Roof
  ...
  replaceable parameter ThermalIntegrationLib.FactoryBuilding.BuildingElements.Records.RoofProperties deviceData constrainedby ThermalIntegrationLib.FactoryBuilding.BuildingElements.Records.RoofProperties annotation (__Dymola_choicesAllMatching=true);
